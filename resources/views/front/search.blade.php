...
<head>
    ...
    <title>Pencarian: {{ $keyword }} - FootVibe</title>
    ...
    <main class="relative z-10 w-full max-w-[1200px] mx-auto mt-8 px-4 mb-20">
        ...
        <div class="flex items-center justify-between mb-8 border-b border-gray-200 pb-4">
            <h1 class="text-2xl font-black italic flex items-center gap-2 tracking-tight text-gray-800 uppercase">
                <i class="fa-solid fa-magnifying-glass text-[#9CE300]"></i> Hasil untuk: "<span class="text-gray-900">{{ $keyword }}</span>"
            </h1>
            <span class="text-sm font-bold text-gray-500 bg-white/60 px-3 py-1.5 rounded-lg border border-white/80">{{ $products->count() }} Ditemukan</span>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-5">
            ...
            <div class="col-span-2 md:col-span-4 text-center py-20 bg-white/50 backdrop-blur-md rounded-3xl border border-white/60 shadow-sm">
                <div class="w-20 h-20 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <i class="fa-solid fa-face-frown text-3xl text-gray-300"></i>
                </div>
                <h3 class="font-bold text-gray-800 text-lg">Pencarian Tidak Ditemukan</h3>
                <p class="text-sm text-gray-500 mt-1">Coba gunakan kata kunci lain seperti merek atau jenis sepatu.</p>
            </div>
            @endforelse
        </div>
    </main>
